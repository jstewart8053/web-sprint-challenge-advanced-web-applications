...
2. What steps can you take in your web apps to keep your data secure?
   You need to have a password and authentication, and be able to control what the users inputs can be, as well as permissions to access data
3. Describe how web servers work.
   A web server is a physical place that allows users to have access to storage files when requested
